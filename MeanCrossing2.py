...
tck_data = odata('KO', datetime(2009, 1, 1),datetime(2020, 4, 20))
...
clspx[['Close', 'EWMA200', 'EWMA100', 'EWMA21']].plot(figsize=(10, 5))
...
ewma_px= np.array(clspx['EWMA21'])
ewma100_px= np.array(clspx['EWMA100'])
ewma200_px= np.array(clspx['EWMA200'])
